...
Acesse a versão online: [https://joburato.github.io/Soundboard-RPG/](https://joburato.github.io/Soundboard-RPG/)
...
*   **JavaScript** (Manipulação de áudio e eventos)

## 📂 Estrutura do Projeto

*   `index.html`: Estrutura principal da aplicação.
*   `styles.css`: Folha de estilos para o layout e design.
*   `Sons/`: Diretório contendo os arquivos de áudio (.mp3, .wav).
*   `Imagens/`: Diretório contendo as imagens dos botões.

## 📝 Como Executar Localmente

1.  Baixe ou clone este repositório.
2.  Certifique-se de que as pastas `Sons` e `Imagens` estão no mesmo diretório que o `index.html`.
